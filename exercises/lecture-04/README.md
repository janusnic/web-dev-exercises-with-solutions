...
```
	- змінити колір тексту першого елемента h2, а не всіх елементів h2. 
### Solutions:
...
```
	- стилізувати посилання, що розташовані всередині будь-якого тегу з класом .first, що є нащадком елементу p
### Solutions:
```css 
	p .first a {
		color: green;
...
```
	...
	- створити стиль для всіх елементів p, що стоять після елемента div.
### Solutions:
```css
	div ~ p {
		color: salmon;
...
7. базовий розмір шрифта для кореневого елемента = 100%
	- визначити розмір шрифта для body, що успадковує розмір шрифта кореневого елемента, збільнкемй на 40 відсотуів
...
```
	- визначити розмір шрифта для h1, що успадковує розмір шрифта кореневого елемента, збільнкемй на 140 відсотуів
```css 
	h1 {  
		font-size: 2.4rem; 
	}
